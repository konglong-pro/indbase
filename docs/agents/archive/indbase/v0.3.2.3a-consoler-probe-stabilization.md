...
phase_id: v0.3.2.3a
phase_slug: v0.3.2.3a-consoler-probe-stabilization
status: completed
canonical: true
read_by_default: false
canonical_spec: docs/planning/archive/v0.3.2.3a/consoler-probe-stabilization.plan.md
---
...
- `docs/agents/archive/indbase/v0.3.2.3-consoler-source-trust-probe.md`
