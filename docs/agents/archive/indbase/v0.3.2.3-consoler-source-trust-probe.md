...
phase_id: v0.3.2.3
phase_slug: v0.3.2.3-consoler-source-trust-probe
status: completed
canonical: true
read_by_default: false
canonical_spec: docs/planning/archive/v0.3.2.3/consoler-source-trust-probe.plan.md
---
...
- `docs/agents/archive/indbase/v0.3.2.2-tag-search-governance.md`
