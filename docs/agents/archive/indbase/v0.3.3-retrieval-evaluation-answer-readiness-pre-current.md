...
superseded_by: docs/agents/current/indbase.md
canonical_spec: docs/planning/active/v0.3.3-retrieval-evaluation-answer-readiness.md
---
...
- `docs/agents/archive/indbase/v0.3.2-retrieval-intelligence-foundation.md`
